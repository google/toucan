...
var rp : RTTPipeline;
rp.red = redTex.CreateColorAttachment(LoadOp.Clear, StoreOp.Store);
rp.green = greenTex.CreateColorAttachment(LoadOp.Clear, StoreOp.Store);
rp.vert = vb;
var rttPass = new RenderPass<RTTPipeline>(encoder, &rp);
var rttPipeline = new RenderPipeline<RTTPipeline>(device, {}, PrimitiveTopology.TriangleList);
...
var b : Bindings;
b.sampler = new Sampler(device, AddressMode.ClampToEdge, AddressMode.ClampToEdge, AddressMode.ClampToEdge, FilterMode.Linear, FilterMode.Linear, FilterMode.Linear);
