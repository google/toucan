...
renderable SampleableTexture2D* framebuffer1 = swapChain1.GetCurrentTextureView();
renderable SampleableTexture2D* framebuffer2 = swapChain2.GetCurrentTextureView();
